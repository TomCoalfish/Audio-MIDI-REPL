...
#define SWIGTYPE_p_SoundWave__matrix_index swig_types[10]
...
#define SWIGTYPE_p_p_p_float swig_types[18]
...
#define SWIGTYPE_p_std__vectorT_SoundWave__ArrayVectorT_float_t_t swig_types[22]
#define SWIGTYPE_p_std__vectorT_SoundWave__SampleVectorT_float_t_t swig_types[23]
#define SWIGTYPE_p_std__vectorT_double_t swig_types[24]
#define SWIGTYPE_p_std__vectorT_float_p_t swig_types[25]
#define SWIGTYPE_p_std__vectorT_float_t swig_types[26]
#define SWIGTYPE_p_std__vectorT_int_t swig_types[27]
#define SWIGTYPE_p_std__vectorT_long_t swig_types[28]
#define SWIGTYPE_p_std__vectorT_short_t swig_types[29]
#define SWIGTYPE_p_std__vectorT_signed_char_t swig_types[30]
#define SWIGTYPE_p_std__vectorT_std__vectorT_float_t_t swig_types[31]
...
static int _wrap_contains_float__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  std::vector< float > arg1 ;
  float arg2 ;
  std::vector< float > *argp1 ;
...
static int _wrap_contains_float__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  std::vector< float > *arg1 = 0 ;
  float arg2 ;
  bool result;
  ...
  SWIG_check_num_args("SoundWave::contains< float >",2,2)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("SoundWave::contains< float >",1,"std::vector< float > const &");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SoundWave::contains< float >",2,"float const");
  ...
  arg2 = (float const)lua_tonumber(L, 2);
  result = (bool)SoundWave::SWIGTEMPLATEDISAMBIGUATOR contains< float >((std::vector< float > const &)*arg1,arg2);
  lua_pushboolean(L,(int)(result!=0)); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_contains_float(lua_State* L) {
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_contains_float__SWIG_0(L);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_contains_float__SWIG_1(L);
      }
    }
  }
  
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'contains_float'\n"
    "  Possible C/C++ prototypes are:\n"
    "    SoundWave::contains< float >(std::vector< float >,float)\n"
    "    SoundWave::contains< float >(std::vector< float > const &,float const)\n");
  lua_error(L);return 0;
}
...
static int _wrap_abs_float__SWIG_10(lua_State* L) {
  int SWIG_arg = 0;
  std::vector< float > *arg1 = 0 ;
  std::vector< float > result;
  
  SWIG_check_num_args("SoundWave::abs< float >",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("SoundWave::abs< float >",1,"std::vector< float > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("abs_float",1,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  result = SoundWave::SWIGTEMPLATEDISAMBIGUATOR abs< float >((std::vector< float > const &)*arg1);
  {
    std::vector< float > * resultptr = new std::vector< float >((const std::vector< float > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__vectorT_float_t,1); SWIG_arg++;
  }
...
static int _wrap_abs_float(lua_State* L) {
  ...
  if (argc == 1) {
    ...
    if (_v) {
      return _wrap_abs_float__SWIG_10(L);
    }
  }
  ...
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'abs_float'\n"
    ...
    "    SoundWave::abs< float >(std::vector< float > const &)\n");
  lua_error(L);return 0;
}
