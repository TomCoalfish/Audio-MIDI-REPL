...
namespace mopo {
  ...
  namespace utils {
    ...
    const Value value_zero = Value(0.0);
    const Value value_one = Value(1.0);
    const Value value_two = Value(2.0);
    const Value value_half= Value(0.5);
    const Value value_fifth = Value(0.2);
    const Value value_tenth = Value(0.1);
    const Value value_pi = Value(PI);
    const Value value_2pi = Value(2.0 * PI);
    const Value value_neg_one = Value(-1.0);
