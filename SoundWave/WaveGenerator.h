...
class WaveGenerator
{
    ...
    std::vector<float> wave; // hmmm ... faster to make this a pointer I bet ....
    std::vector<float> history; // a running averaged wave, for rendering purposes
